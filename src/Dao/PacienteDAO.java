...
public class PacienteDAO {
    ...
    public boolean insert(Paciente paciente) throws SQLException {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            ps.setTimestamp(6, java.sql.Timestamp.valueOf(paciente.getFechaNacimiento().atStartOfDay()));
    ...
    private Paciente mapPaciente(ResultSet rs) throws SQLException {
        ...
        paciente.setFechaNacimiento(rs.getTimestamp("fecha_nacimiento").toLocalDateTime().toLocalDate());
        return paciente;
    }
}
